...
class DisplayBoard():
    ...
    def __init__(self, board):
        ...
        self.chessBoard = py.image.load("C:\\Users\\quach\\Downloads\\CHESSBOT_AI-20241220T033735Z-001\\CHESSBOT_AI\\Image\\Board.jpg").convert_alpha()
...
# From here is only UI stuff to display menus and buttons ect.
    ...
    def main_menu(self):
        ...
        while self.intro:
            ...
            # Tự động gán self.set_up là "W" (quân trắng)
            self.set_up = "W"
        
            self.button("PLAY", 115, 250, 100, 50, green, bright_green, 1)
            self.button("QUIT", 285, 250, 100, 50, red, bright_red, 2)
    ...
    def game_over_menu(self):
        ...
        while self.game_over:
            ...
            if self.board.turn == chess.WHITE:
                TextSurf, TextRect = self.text_objects("BOT WON", mediumText)
            else:
                TextSurf, TextRect = self.text_objects("PLAYER WON", mediumText)

            TextRect.center = ((self.dim / 2), (self.dim / 2) - 20)
            self.win.blit(TextSurf, TextRect)

            self.button("AGAIN", 115, 300, 100, 50, green, bright_green, 3)
            self.button("QUIT", 285, 300, 100, 50, red, bright_red, 2)
...
class Piece():
    ...
    def __init__(self, name, color):
        ...
        if (self.color == "W") or (self.color == "White"):
            if self.name != "Knight":
                self.pieceSurface = py.image.load("C:\\Users\\quach\\Downloads\\CHESSBOT_AI-20241220T033735Z-001\\CHESSBOT_AI\\Image\\Chess_"+self.name.lower()[0]+"lt60.png")
            else:
                self.pieceSurface = py.image.load("C:\\Users\\quach\\Downloads\\CHESSBOT_AI-20241220T033735Z-001\\CHESSBOT_AI\\Image\\Chess_nlt60.png")
        else:
            if self.name != "Knight":
                self.pieceSurface = py.image.load("C:\\Users\\quach\\Downloads\\CHESSBOT_AI-20241220T033735Z-001\\CHESSBOT_AI\\Image\\Chess_" + self.name.lower()[0] + "dt60.png")
            else:
                self.pieceSurface = py.image.load("C:\\Users\\quach\\Downloads\\CHESSBOT_AI-20241220T033735Z-001\\CHESSBOT_AI\\Image\\Chess_ndt60.png")
